...
public class TimeTableTest {
	...
	GregorianCalendar gc0 = new GregorianCalendar(2018, 0, 28);
	GregorianCalendar gcFirst = new GregorianCalendar(2018, 0, 30);
	GregorianCalendar gcSecond = new GregorianCalendar(2018, 1, 6);
	GregorianCalendar gcThird = new GregorianCalendar(2018, 2, 13);
	GregorianCalendar gcLast = new GregorianCalendar(2019, 0, 30);
	...
	Appt badAppt = new Appt(12, 30, 32, 1, 2018, "", "");
	...
	public void testGetApptRange()
	{
		...
		try {
			...
			assertEquals(gcSecond.get(GregorianCalendar.DAY_OF_MONTH)-1, range.get(range.size()-1).getDay());
		...
		try {
			...
			assertEquals(day1.getDay(), range.get(0).getDay());
			assertEquals(gcThird.get(GregorianCalendar.DAY_OF_MONTH)-1, range.get(range.size()-1).getDay());
		} catch (DateOutOfRangeException e) {
			assertTrue(false);
		}
		...
		try {
			...
			assertEquals(day1.getDay(), range.get(0).getDay());
			assertEquals(gcLast.get(GregorianCalendar.DAY_OF_MONTH)-1, range.get(range.size()-1).getDay());
		} catch (DateOutOfRangeException e) {
			assertTrue(false);
		}
